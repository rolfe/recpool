...
LOCAL_CONNECTIONS_ONLY_EXPLAINING_AWAY_MATRIX = 4 -- filter the explaining_away weight matrix with a matrix that contains entries in the set {0,1} that only allows local connections between units
