...
\end{equation*}  
where $\left[h_{\theta}(\mathbf{z}) \right]_i = \text{sign}\left(z_i \right) \cdot \max\left(\left|z_i \right| - \theta \right)$ and $\alpha$ is a small step-size parameter. %, and $t \rightarrow \infty$.
