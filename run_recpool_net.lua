...
pooling_shrink_position_L2_mag = 1e-3 --0.0001 --0.01 --0.005 --0
pooling_orig_position_L2_mag = 0 --0.005 --0.1
local pooling_reconstruction_scaling = 1.5 --0.85 --0.5 --0.25
...
-- GROUP SPARSITY TEST
rec_mag = 5 --4 --5 --4
L1_scaling = 6 --7.5 --5.5 --7.5 --6 is not too large; 9 is too large
--]]
