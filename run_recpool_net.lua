...
local quick_train_learning_rate = 5e-3 --10e-3 --2e-3 --math.max(1, desired_minibatch_size) * 2e-3 --25e-3 --(1/6)*2e-3 --2e-3 --5e-3
local full_train_learning_rate = 5e-3 --10e-3 --math.max(1, desired_minibatch_size) * 2e-3 --10e-3
